...
public class PalindromeChecker {
    public static void main(String[] args) {
        ...
        PalindromeToolkit toolkit = new PalindromeToolkit();

        boolean iterative = toolkit.isPalindromeIterative(text);
        boolean recursive = toolkit.isPalindromeRecursive(text);
        boolean arrayReversal = toolkit.isPalindromeArrayReversal(text);
